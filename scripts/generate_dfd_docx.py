...
def main():
    ...
    p._element.append(parse_xml(create_vml_shape("oval", 75, 40, 45, 20, "Process", fill_color=COLOR_PROCESS)))
    ...
    p._element.append(parse_xml(create_vml_shape("oval", 380, 50, 80, 60, "8.0 Review &amp; Feedback", fill_color=COLOR_PROCESS)))
    ...
    p._element.append(parse_xml(create_vml_shape("oval", 100, 380, 100, 80, "1.0 User\nAuthentication", fill_color=COLOR_PROCESS)))
    ...
    p._element.append(parse_xml(create_vml_shape("oval", 300, 380, 120, 80, "2.0 Content\nManagement", fill_color=COLOR_PROCESS)))
    ...
    p._element.append(parse_xml(create_vml_shape("oval", 700, 380, 120, 80, "3.0 Interactive\nMap Display", fill_color=COLOR_PROCESS)))
