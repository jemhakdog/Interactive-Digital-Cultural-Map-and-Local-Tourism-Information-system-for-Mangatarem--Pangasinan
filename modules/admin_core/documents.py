...
def admin_document_create(slug):
    ...
    return redirect(url_for("v1_docs.v1_document_create", slug=slug, **request.args), code=302)
...
def admin_document_record_edit(record_id):
    ...
    return redirect(url_for("v1_docs.v1_document_record_edit", record_id=record_id, **request.args), code=302)
...
def admin_documents():
    ...
    return redirect(url_for("v1_docs.v1_documents_view", **request.args), code=302)
...
def admin_document_category_files(category_name):
    ...
    return redirect(url_for("v1_docs.v1_document_category_files", category_name=category_name, **request.args), code=302)
...
def admin_document_files(slug):
    ...
    return redirect(url_for("v1_docs.v1_document_files", slug=slug, **request.args), code=302)
...
def admin_document_view(slug):
    ...
    return redirect(url_for("v1_docs.v1_document_view", slug=slug, **request.args), code=302)
...
def admin_document_edit(slug):
    ...
    return redirect(url_for("v1_docs.v1_document_edit", slug=slug, **request.args), code=302)
...
def admin_document_export(slug):
    ...
    return redirect(url_for("v1_docs.v1_document_export", slug=slug, **request.args), code=302)
...
def admin_documents_export_all():
    ...
    return redirect(url_for("v1_docs.v1_documents_export_all", **request.args), code=302)
...
def admin_document_import():
    ...
    return redirect(url_for("v1_docs.v1_document_import", **request.args), code=302)
